...
ENCODER = VOLUME/MUTE
"""
# https://learn.adafruit.com/macropad-hotkeys?view=all
...
text_lines[1].text = "^up    ^left   ^right"
text_lines[2].text = "<<   pause/play    >>"
text_lines[3].text = "mute    vol-     vol+"
text_lines.show()
    ...
    if key_event:
        if key_event.pressed:
            ...
            if key_event.key_number == 2: #Sleep Display 
                ...
                macropad.keyboard.release_all()
            if key_event.key_number == 3: #MC
                macropad.keyboard.press(macropad.Keycode.CONTROL, macropad.Keycode.UP_ARROW)
                macropad.keyboard.release_all()
            if key_event.key_number == 4: #DOWN ARROW
                macropad.keyboard.press(macropad.Keycode.CONTROL, macropad.Keycode.LEFT_ARROW)
                macropad.keyboard.release_all()
            if key_event.key_number == 5: #RIGHT ARROW
                macropad.keyboard.press(macropad.Keycode.CONTROL, macropad.Keycode.RIGHT_ARROW)
                macropad.keyboard.release_all()
            ...
            if key_event.key_number == 9: #MUTE
                ...
                macropad.pixels.brightness = 0.5
                macropad.keyboard.release_all()
            if key_event.key_number == 10: #Vol Down
                ...
                macropad.pixels.brightness = 0.5
                macropad.keyboard.release_all()
            if key_event.key_number == 11: #Vol Up
                #macropad.keyboard.press(macropad.Keycode.COMMAND, macropad.Keycode.Z)
                macropad.consumer_control.send(
